module github.com/dimo/dimo-node

go 1.21.3

replace github.com/dimo/dimo-node/infrastructure => ./infrastructure

replace github.com/dimo/dimo-node/dependencies => ./dependencies
...
require (
	...
	github.com/pulumi/pulumi-gcp/sdk/v7 v7.12.0 // indirect
